...
class_labels = {1: 'person', 2: 'bicycle', 3: 'car', 4: 'motorcycle', 6: 'bus', 8: 'truck'}
...
def perform_object_detection(frame):  # , tracker):
    ...
    for box, label, score in zip(filtered_boxes, filtered_labels, filtered_scores):
        ...
        cv2.putText(frame, label_text, (int(xmin), int(ymax) + label_size[1] + 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                    (0, 255, 0), 2)
